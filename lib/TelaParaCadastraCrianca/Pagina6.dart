...
class Pagina6Data {
  ...
  Pagina6Data({
    this.brinquedos,
    this.coisasfavoritas,
    this.acessoriofavoritos,
    this.animaisfavoritos,
    this.historiacoisasfavoritas,
    this.historiacoisasNaofavoritas,
    this.selecionadoParentesco,
    this.selecionadoProcessoAlf,
  });
